...
setwd("~/Documents/phd/code/drought wheat 72 hours")
...
plot(1:15, AllData[1,1:15], type = "l", col = pal[1], ylim = c(-50000, 500000))
par(mfrow=c(2,2))
for(ip in 1:4) {
  plot(1:15, AllData[1,1:15], type = "l", col = pal[ip], ylim = c(-50000, 500000))
  for(i in 1:30) {
    lines(1:15, AllData[i*ip,1:15], col = pal[ip], ylim = c(-50000, 500000))
  }
}
...
plot(1:459, AllData[1,1:459], type = "l", col = pal[1], ylim = c(-25, 30))
par(mfrow=c(2,2))
for(ip in 1:4) {
  plot(1:459, AllData[1,1:459], type = "l", col = pal[ip], ylim = c(-25, 30))
  for(i in 1:30) {
    lines(1:459, AllData[i*ip,1:459], col = pal[ip], ylim = c(-25, 30))
  }
}
##################################################################################################################################
...
groups <- cutree(fit, k=4) # k=23 -> 23 groups
plot(groups)
